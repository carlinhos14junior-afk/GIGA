          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="hidden sm:block">
                <Logo size="md" lightVersion={true} logoUrl={config.logo_url} logoWhiteUrl={config.logo_white_url} nomeEmpresa={config.nome_empresa} />
              </div>
              <div className="block sm:hidden">
                <Logo size="sm" lightVersion={true} logoUrl={config.logo_mobile_url || config.logo_url} logoWhiteUrl={config.logo_white_url} nomeEmpresa={config.nome_empresa} />
              </div>
            </div>
